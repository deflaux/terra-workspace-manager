...
/**
 * Gets an Azure Network, and fails if it already exists. This step is designed to run immediately before
 * {@link CreateAzureNetworkStep} to ensure idempotency of the create operation.
 */
